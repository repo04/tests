...
public class Contact extends BaseClass {
     ...
     * @param user
     */
    void verifyEmailAddressIsNotVisibleWhenHideMyEmailAddressFromEveryOneIsSelectedForUser(String user) {
        int i = locateContact(user);
     ...
     * @param user
     */
    void verifyEmailAddressIsVisibleWhenAllowEveryoneToSeeMyEmailAddressIsSelectedForUser(String user) {
        int i = locateContact(user);
        driver.findElement(By.xpath("//li[" + i + "]/div/div[2]/div/a")).click();
