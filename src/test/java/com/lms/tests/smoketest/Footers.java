    ...
    void verifyFooters() {
        switch (getProgram()) {
            ...
            case "gu-msn":
                ...
                privacyConsent = "By using the " + xpv.getTokenValue(getProgram() + "SupportName")
                ...
                termsOfAgreement = xpv.getTokenValue(getProgram() + "SupportName") + " CAMPUS TERMS OF USE AGREEMENT";
            ...
            case "gwu-mph":
                ...
                termsOfAgreement = xpv.getTokenValue(getProgram() + "SupportName") + " WEBSITE TERMS OF USE AGREEMENT";
        ...
        for (String footer : footers) {
            if (i == 1) {
                ...
                try {
                    ...
                    if (i == 2) {
                        ip.isTextPresentByXPATH(driver, xpv.getTokenValue(getProgram() + "TermsOfAgreementTitleXPATH"), termsOfAgreement);
                    } else {
                        ip.isTextPresentByXPATH(driver, xpv.getTokenValue(getProgram() + "PrvcyCnstXPATH"), privacyConsent);
                        ip.isTextPresentByXPATH(driver, xpv.getTokenValue(getProgram() + "PrvcyCntctXPATH"), privacyContact);
                    }
                    driver.close();
