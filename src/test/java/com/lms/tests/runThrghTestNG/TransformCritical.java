...
public class TransformCritical implements IAnnotationTransformer {
    ...
    public void transform(ITestAnnotation annotation, Class testClass,
        ...
        if ("testTeacherVerifyCriticalSmokeTestEmails".equals(testMethod.getName())) {
            ...
            DependentMethods[0] = "com.lms.tests.runThrghTestNG.Student_JoinSocialGroup_Post.testStudentJoinsTeacherSocialGroup";
            DependentMethods[1] = "com.lms.tests.runThrghTestNG.Student_JoinSocialGroup_Post.testStudentCommentOnTeacherCoursePost";
            DependentMethods[2] = "com.lms.tests.runThrghTestNG.Teacher_JoinDelete_SocialGroup.testTeacherJoinsStudentSocialGroup";
            DependentMethods[3] = "com.lms.tests.runThrghTestNG.Student_DeleteSocialGroup.testStudentDeleteSocialGroup";
            annotation.setDependsOnMethods(DependentMethods);
        }
        ...
        if ("testStudentVerifyCriticalSmokeTestEmails".equals(testMethod.getName())) {
            ...
            DependentMethods = new String[4];
            DependentMethods[0] = "com.lms.tests.runThrghTestNG.Teacher_Posts_SocialGroup.testTeacherPostURLOnStudentsWall";
